...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_main_css__ = __webpack_require__(54);
...
class Player extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    _renderImg() {
        ...
        for (var i in this.props.images) {
            ...
            images.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { onError: this._onError, src: link, 'class': 'img' }));
        }
        console.log(images);
        return images;
    }
    ...
    getPlayers() {
        ...
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/play').then(resp => {
            ...
            for (var player in players) {
                ...
                list.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Player, { name: p['player_tag'], images: imgs }));
            }
            this.setState({ list });
