...
*/
var aa=__webpack_require__(5),l=__webpack_require__(9),B=__webpack_require__(3),C=__webpack_require__(1),ba=__webpack_require__(10),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(13),ia=__webpack_require__(14),D=__webpack_require__(4);
...
class Player extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    constructor(props) {
        super(props);
        this._renderImg = this.renderImg.bind(this);
    }

    _renderImg() {
        images = [];
        for (var i in this.props.images) {
            link = this.props.images[i];
            images.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: link }));
        }
    }
...
class OWS extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    constructor() {
        super();
        this.state = {
            list: []
    ...
    getPlayers() {
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/api/play').then(resp => {
            const players = resp.data;
            console.log(players);
            for (var player in players) {
                console.log(players[player]);
                let p = players[player];
                img_keys = ['char_one_image', 'char_two_image', 'char_three_image', 'char_four_image', 'char_five_image'];
                imgs = img_keys.map(img => p[img]);
                this.state.list.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Player, { name: p['player_tag'], images: imgs }));
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(OWS, null), document.getElementById('container'));
